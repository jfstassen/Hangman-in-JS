...
let mot = Array.from(randomWord.toUpperCase());
let motDevine = new Array(mot.length).fill('_');
let chiffre = 0;
  ...
  for (let i = 0; i < mot.length; i++) {
    ...
    if(!trouver){
        ...
        if(tries == 0){
            ...
            document.getElementById("tries").textContent = "PERDU";
            document.getElementById("field").textContent = mot.join(" ");
        }
    }

  if (chiffre == mot.length) {
    alert("Bien joué");
  }}
